    ...
    for epoch in range(config.start_epoch, config.num_epochs):
        ...
        for ba in range(config.batch_size):
            ...
            next_node_feats, next_adj_mats, \
                next_switch_mask, reward, done = traj_gen.step(masked_a)
        ...
        monitor.add_scalar('Loss/p_loss_good_exp', p_loss, epoch)
        monitor.add_scalar('Loss/v_loss_good_exp', v_loss, epoch)
